...
Claude Code に日本語で「今日はどれくらい作業した?」と尋ねると、`claude-observability` Skill が Prometheus に問い合わせて要約を返しつつ、詳細確認用に「利用サマリー」ダッシュボードへのリンクも返す(2026-07-06、Claude Code v2.1.201 で確認)。実際の画面例は [site/index.html](site/index.html) を参照。
